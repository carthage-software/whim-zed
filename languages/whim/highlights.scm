...
(cpu_architecture_construct "cpu_architecture" @function.macro)
(operating_system_construct "operating_system" @function.macro)
(operating_system_family_construct "operating_system_family" @function.macro)
(shared_library_prefix_construct "shared_library_prefix" @function.macro)
(shared_library_suffix_construct "shared_library_suffix" @function.macro)
(shared_library_extension_construct "shared_library_extension" @function.macro)
(executable_suffix_construct "executable_suffix" @function.macro)
(executable_extension_construct "executable_extension" @function.macro)
